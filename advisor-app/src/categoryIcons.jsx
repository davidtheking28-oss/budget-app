...
const RULES = [
  ...
  [/בריאות|ביטוח|בעלי חיים/, 'health'],
  [/דיור|משכנת|שכר דיר|ועד בית|חשמל|מים|ארנונה|גז\b/, 'home'],
  [/ילדים|חוגים|קייטנ|עזרת|שמרטף/, 'family'],
  [/חופש|טיול/, 'travel'],
  [/ביגוד|הנעלה|תספורת|קוסמטיקה|פארם|מתנות/, 'shopping'],
  [/מניות|הוראת קבע לחסכון|ריבית|עמלת|כרטיס אשראי|הלוואות|תשלומים/, 'finance']
];
